...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://ibb.co/WFWy9gk.jpg";
...
module.exports = {
  ...
  packname: process.env.PACK_NAME || "𝗨𝗚𝗔𝗡𝗗𝗔 𝗙𝗥𝗔𝗡𝗞",
  botname: process.env.BOT_NAME || "𝗙𝗥𝗔𝗡𝗞 𝗣𝗥𝗢 𝗨𝗚",
